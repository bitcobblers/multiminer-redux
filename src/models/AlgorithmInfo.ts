...
export const AVAILABLE_ALGORITHMS: AlgorithmInfo[] = [
  ...
  { name: 'karlsenhash', kind: 'GPU', scale: 'GH/s', efficiencyScale: 'MH/W', minRam: 3 },
  { name: 'pyrinhash', kind: 'GPU', scale: 'GH/s', efficiencyScale: 'MH/W', minRam: 3 },
  { name: 'sha512', kind: 'GPU', scale: 'GH/s', efficiencyScale: 'MH/W', minRam: 3 },
  { name: 'xelishash', kind: 'GPU', scale: 'KH/s', efficiencyScale: 'KH/W', minRam: 3 },
  ...
  { name: 'blake3', kind: 'GPU', scale: 'GH/s', efficiencyScale: 'MH/W', minRam: 4 },
  ...
  { name: 'dynexsolve', kind: 'GPU', scale: 'H/s', efficiencyScale: 'H/W', minRam: 6 },
